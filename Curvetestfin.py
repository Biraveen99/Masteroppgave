...
def gradual_cpu_load():
    """
    Gradually increases CPU usage from 10% to 90% and then back down to 10% over 1 hour.
    """
    load_levels = [10, 20, 30, 50, 60, 70, 80, 90, 80, 70, 60, 50, 30, 20, 10]  # Increase and then decrease
    ...
    for load in load_levels:
        ...
        print(f"[DEBUG] Adjusting CPU load to {load}%...")
        ...
        for t in threads:
            t.join()  # Wait for all threads before changing load
